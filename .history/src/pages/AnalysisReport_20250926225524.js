...
import { generateFullReportPDF } from '../components/ReportsPDFFull';
                ...
                <div className="filter-container mt-8">
                    <div className="chart-filters">
                        <div className="filter-group">
                            ...
                            <div className="export-button-container" style={{ marginBottom: 20 }}>
                                <button
                                    onClick={() => generateFullReportPDF({ users, feedbacks })}
                                    style={{
                                        padding: '10px 20px',
                                        background: '#3498DB',
                                        color: '#fff',
