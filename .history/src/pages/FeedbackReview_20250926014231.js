                ...
                <div className="main-content">
                    ...
                    <div className="ratings-drilldown" style={{ marginTop: 20 }}>
                        ...
                        {viewLevel === "quarterly" && (
                            <div className="drill-grid">
                                {quartersForYear(selectedYear).map(qObj => (
                                    ...
                                    >
                                        <small className="top">Top: {qObj.topLow.top}</small>
                                        <small className="low">Low: {qObj.topLow.low}</small>
                                    </PeriodCard>
                                ))}
                            </div>
                        )}
                        ...
                        {viewLevel === "monthly" && selectedYear && selectedQuarter && (
                            <div className="drill-grid">
                                {monthsForQuarter(selectedYear, selectedQuarter).map(mObj => (
                                    ...
                                    >
                                        <small className="top">Top: {mObj.topLow.top}</small>
                                        <small className="low">Low: {mObj.topLow.low}</small>
                                    </PeriodCard>
                                ))}
                            </div>
                        )}
                        ...
                        {viewLevel === "weekly" && selectedMonth && (
                            <div className="drill-grid">
                                {weeksForMonth(selectedMonth.year, selectedMonth.monthIndex).map(wObj => (
                                    <PeriodCard
                                        key={wObj.label}
                                        title={wObj.label}
                                        avg={wObj.avg}
                                    ...
                                    >
                                        <small className="top">Top: {wObj.topLow.top}</small>
                                        <small className="low">Low: {wObj.topLow.low}</small>
                                    </PeriodCard>
                                ))}
                            </div>
                        )}
                        ...
                        {viewLevel === "daily" && selectedWeekRange && (
                            <div className="drill-grid">
                                {daysForWeek(selectedWeekRange.start, selectedWeekRange.end).map(dObj => (
                                    <PeriodCard
                                        key={dObj.label}
                                        title={dObj.label}
                                        avg={dObj.avg}
                                    ...
                                    >
                                        <small className="top">Top: {dObj.topLow.top}</small>
                                        <small className="low">Low: {dObj.topLow.low}</small>
                                    </PeriodCard>
                                ))}
                            </div>
                        )}
