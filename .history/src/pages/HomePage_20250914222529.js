...
const HomePage = () => {
    ...
    // Helper hook for scroll fade-in
    ...
    const infoSlides = useFadeInOnScroll();
    const howItWorks = useFadeInOnScroll();
    const aboutUs = useFadeInOnScroll();
    const partnership = useFadeInOnScroll();
    ...
    return (
        <div className="home-wrapper">
            ...
            {/* Info Slides Section */}
            <div ref={infoSlides.ref} className={`fade-in-section ${infoSlides.isVisible ? 'visible' : ''}`}>
            ...
            {/* How TourKita Works */}
            <div ref={howItWorks.ref} className={`fade-in-section ${howItWorks.isVisible ? 'visible' : ''}`}>
            ...
            {/* About Us */}
            <div ref={aboutUs.ref} className={`fade-in-section ${aboutUs.isVisible ? 'visible' : ''}`}>
            ...
            {/* Partnership */}
            <div ref={partnership.ref} className={`fade-in-section ${partnership.isVisible ? 'visible' : ''}`}>
