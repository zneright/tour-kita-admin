                ...
                <div className="main-content">
                    ...
                    <div className="ratings-drilldown" style={{ marginTop: 20 }}>
                        ...
                        {viewLevel === "weekly" && selectedMonth && (
                            <h3>
                                Weeks —{" "}
                                {selectedMonth?.year !== undefined && selectedMonth?.monthIndex !== undefined
                                    ? format(new Date(selectedMonth.year, selectedMonth.monthIndex, 1), "LLLL yyyy")
                                    : ""}
                            </h3>
                        )}
                    ...
                    {viewLevel === "daily" && selectedWeekRange && (
                        <>
                            <h3>
                                Days in {format(selectedWeekRange.start, "MMM yyyy")}
                            </h3>
                            <div className="drill-row">
