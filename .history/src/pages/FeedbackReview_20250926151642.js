                    ...
                    {loading
                        ? Array.from({ length: 4 }).map((_, i) => (
                            <div
                                ...
                                style={{ minWidth: '200px', minHeight: '140px', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start', gap: '8px' }}
                            >
                                ...
                                <div
                                    ...
                                    style={{ width: '60%', height: '20px', borderRadius: '6px' }}
                                ></div>
                                <div
