            ...
            <div className="dashboard-main">
                ...
                <div className="main-content">
                    ...
                    <div className="ratings-drilldown" style={{ marginTop: 20 }}>
                        ...
                        {viewLevel === "weekly" && (
                            <>
                                <h3>Weeks in {format(selectedMonth.start, "MMMM yyyy")}</h3>
                                <div className="drill-row">
                                    {weeksForMonth(selectedMonth.start).map((wObj, idx) => {
                        ...
                        {viewLevel === "daily" && (
                            <>
                                <h3>
                                    Days in {format(selectedWeekRange[0], "MMM yyyy")}
                                </h3>
                                <div className="drill-row">
                                    {daysForWeekRange.map((day) => {
                                        const start = startOfDay(day);
                                        const end = endOfDay(day);
                                        const entries = entriesFor(start, end, activeTab);
                                        const avgValue = averageForEntries(entries);
                                        const { top, low } = topAndBottomForEntries(entries);
