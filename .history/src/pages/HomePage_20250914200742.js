    ...
    return (
        <div className="home-wrapper">
            ...
            <div className="carousel-wrapper">
                ...
                {/* Floating shapes */}
                <div className="floating-circle" style={{ width: 60, height: 60, top: 100, left: 50 }} />
                <div className="floating-circle" style={{ width: 40, height: 40, top: 250, left: 200 }} />
                <div className="floating-circle" style={{ width: 50, height: 50, top: 150, right: 100 }} />
            </div>
            ...
            <section ref={stepsRef} className="how-tourkita-works fade-in-section">
                ...
                <div className="tourkita-steps-container">
                    <div className="tourkita-step-card fade-in-section">
