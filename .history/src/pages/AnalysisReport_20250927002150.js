                        ...
                        <div className="filter-group">
                            ...
                            <button
                                ...
                                style={{ marginLeft: '1rem' 
                                    cursor: 'pointer', backgroundColor: '#e74c3c', color: '#fff', border: 'none', padding: '0.5rem 1rem', borderRadius: '5px', display: 'flex', alignItems: 'center'
                                }}
                            >
                                <FaFilePdf /> Download User Analytics PDF
                            </button>
