        ...
        try {
            ...
            const fetchedEvents = eventSnap.docs.map(doc => {
                ...
                return {
                    ...
                    ...data,
                    title: data.title,
                    startDate: data.date?.toDate ? data.date.toDate() : new Date(data.date),
                    ...
                    <>
                        ...
                        <div className="event-calendar-wrapper">
                            <EventCalendar
                                ...
                                onEventClick={(event) => {
                                    setEventForm({
                                        ...event,
                                        recurrence: event.recurrence || { frequency: "once", daysOfWeek: [], endDate: "" },
                        ...
                        <EventFormModal
                            ...
                            onUpdate={(updated) => {
                                setEventForm({
                                    ...updated,
                                    eventStartTime: formatTime12Hour(updated.eventStartTime),
                                    eventEndTime: formatTime12Hour(updated.eventEndTime),
                                });
