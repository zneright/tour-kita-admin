                    ...
                    {loading ? (
                        ...
                        <>
                            ...
                            <div className="card brown">
                                ...
                                <p className="big-number">{feedbacks.length}</p>
                            </div>
                            <div className="card brown">
                                <FaMapMarkerAlt size={22} color="#9B59B6" />
                                <h2>Top Location</h2>
                                <p className="big-number">{topRatedLocation ? topRatedLocation.name : 'N/A'}</p>
                            </div>
                            <div className="card brown">
                                <FaUsers size={22} color="#E74C3C" />
                                <h2>Guest Users</h2>
                                <p className="big-number">{guestUsers.length}</p>
                            </div>
                        </>
                    )}
                </div>
