...
const HomePage = () => {
    ...
    return (
        <div className="home-wrapper">
            ...
            <section className="how-tourkita-works fade-in-section">
            ...
            <section className="about-us-section fade-in-section">
            ...
            <section className="partnership-section fade-in-section">
