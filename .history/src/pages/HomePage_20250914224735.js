...
const HomePage = () => {
    ...
    return (
        <div className={`home-wrapper ${modalActive ? 'modal-active' : ''}`}>
            {/* Header */}
                ...
                <div className="info-slides">
                    <div
                        ...
                        onClick={() =>
                            handleCardClick(
                                'Augmented Reality',
                                'See the past come alive with AR visuals of historical sites and people.'
                            )
                        }
                    >
                    ...
                    <div
                        ...
                        onClick={() =>
                            handleCardClick(
                                'Live Navigation',
                                'Get directions to landmarks and explore hidden gems around Intramuros.'
                            )
                        }
                    >
                    ...
                    <div
                        ...
                        onClick={() =>
                            handleCardClick(
                                'Interactive Guides',
                                'Tap on pins to learn about places, restaurants, events, and more.'
                            )
                        }
                    >
            ...
            {/* Modal */}
            {modalActive && (
                <div id="modal-overlay" className="active" onClick={(e) => e.target === e.currentTarget && closeModal()}>
                    <div id="modal-card">
                        <button id="modal-close" onClick={closeModal}>&times;</button>
                        <h2 id="modal-title">{modalData.title}</h2>
                        <p id="modal-text">{modalData.text}</p>
                    </div>
                </div>
            )}
