                ...
                <form onSubmit={handleSubmit} className="marker-form">
                    ...
                    <div className="field-group full-width">
                        ...
                        <select
                            ...
                            disabled={isDisabled || !!formData.customAddress} // disable if map used
                        >
                        ...
                        {/* Map Location Picker */}
                        <div className={`map-wrapper ${formData.locationId ? "disabled" : ""}`}>
                            <LocationPickerMap
                                onLocationSelect={({ lng, lat, address }) => {
                                    setFormData(prev => ({
                                        ...prev,
                                        locationId: "", // clear dropdown if map used
                    ...
                    {/* Show End Date only if recurrence is weekly */}
