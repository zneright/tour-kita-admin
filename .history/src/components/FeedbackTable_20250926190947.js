...
const FeedbackTable = ({
    ...
    // Local states if parent doesn't control them
    const [searchTerm, setSearchTerm] = parentSearchTerm !== undefined ? [parentSearchTerm, parentSetSearchTerm] : useState("");
    const [startDate, setStartDate] = parentStartDate !== undefined ? [parentStartDate, parentSetStartDate] : useState("");
    const [endDate, setEndDate] = parentEndDate !== undefined ? [parentEndDate, parentSetEndDate] : useState("");
    const [filterContext, setFilterContext] = parentFilterContext !== undefined ? [parentFilterContext, parentSetFilterContext] : useState("");

    // Unique options for filter dropdown
