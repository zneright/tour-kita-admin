...
const ExportButtons = ({ users }) => {
    ...
    const handleExportPDF = () => {
        ...
        autoTable(doc, {
            ...
            startY: 28,
            theme: 'striped',
            styles: { fontSize: 9, cellWidth: 'wrap' }, // ✅ Enable text wrap
            headStyles: { fillColor: [41, 128, 185], textColor: 255 }, // Optional: styled header
            columnStyles: {
                1: { cellWidth: 40 }, // User ID column width
                2: { cellWidth: 50 }, // Email column width
                3: { cellWidth: 50 }, // Name column width
            },
        });
