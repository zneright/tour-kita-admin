...
const getDateKey = (date: Date | null) => (date ? formatLocalDate(date) : null);
                ...
                <div className="calendar-grid">
                    {calendarDates.map((date, index) => {
                        ...
                        return (
                            ...
                            >
                                {date && <div className={`calendar-date ${isToday(date) ? "today" : ""}`}>{date.getDate()}</div>}
                                ...
                                {dayEvents.map((event, i) => (
                                    ...
                                    >
                                        ...
                                        <div className="event-time">
                                            {formatTime12Hour(event.eventStartTime)} - {formatTime12Hour(event.eventEndTime)}
                                        </div>
