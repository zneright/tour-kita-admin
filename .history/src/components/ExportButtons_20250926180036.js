...
const ExportButtons = ({ users }) => {
    const PDF_PASSWORD = '1234'; // Set PDF password
    const EXCEL_PASSWORD = '1234'; // Excel export (informational only)
    ...
    const handleExportExcel = () => {
        ...
        // Excel password protection is limited client-side
