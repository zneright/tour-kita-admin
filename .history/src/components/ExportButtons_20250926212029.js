...
const ExportButtons = ({ users }) => {
    ...
    const handleExportPDF = () => {
        const doc = new jsPDF('l', 'pt', 'a4'); // landscape mode for wide tables
        ...
        autoTable(doc, {
            ...
            columnStyles: {
                1: { cellWidth: 60 },  // User ID
                2: { cellWidth: 80 },  // Email
                3: { cellWidth: 80 },  // Name
                6: { cellWidth: 70 },  // Contact Number
                10: { cellWidth: 70 }, // Registered Date
            },
            didDrawCell: (data) => {
                // optional: can style specific cells here
            },
            tableWidth: 'auto' // automatically adjust other columns
        });
