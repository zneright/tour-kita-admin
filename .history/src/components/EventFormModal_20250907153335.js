    ...
    const handleSubmit = async e => {
        ...
        try {
            ...
            const eventData = {
                ...
                endDate: formData.recurrence?.frequency === "once" ? formData.startDate : formData.recurrence?.endDate,
                ...
                <form onSubmit={handleSubmit} className="marker-form">
                    ...
                    <div className="field-group full-width">
                        ...
                        <select
                            ...
                            disabled={isDisabled || !!formData.customAddress}  // ✅ disable if custom address is filled
                        >
                        ...
                        <small>Or enter a custom address below:</small>
                        <input
                            type="text"
                            name="customAddress"
                            ...
                            onChange={handleChange}
                            disabled={isDisabled || !!formData.locationId}  // ✅ disable if marker is chosen
                        />
                    </div>
