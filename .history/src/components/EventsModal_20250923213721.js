        ...
        const fetchEvent = async () => {
            ...
            try {
                ...
                if (snap.exists()) {
                    ...
                    // ✅ Convert times to 12-hour format before setting formData
                    const formattedStart = formatTime12Hour(data.eventStartTime);
                    const formattedEnd = formatTime12Hour(data.eventEndTime);

                    setFormData({
                        id: snap.id,
                        ...data,
                        eventStartTime: formattedStart,
                        eventEndTime: formattedEnd,
                    });
                }
            } catch (err) {
